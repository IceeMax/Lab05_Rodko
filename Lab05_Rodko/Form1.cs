...
namespace Lab05_Rodko
{
    public partial class Form1 : Form
    {
        ...
        private void bStart_Click_1(object sender, EventArgs e)
        {
            ...
            long lengthINfile = new FileInfo(tInFilePath.Text).Length;// / (2 ^ 20);
            labelInLength.Text = Convert.ToString(lengthINfile);
            stopwatch.Start();
            ...
            long lengthOUTfile = new FileInfo(tOutFilePath.Text).Length;
            labelOutLength.Text = Convert.ToString(lengthOUTfile);
